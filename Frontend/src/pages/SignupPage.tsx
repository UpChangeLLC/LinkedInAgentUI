...
export function SignupPage({ submitting, errorMessage, onSubmit, onRestore, onOAuth, onBack }: SignupPageProps) {
      ...
      >
        <div className="max-w-xl mx-auto">
          ...
          <Card className="p-8 md:p-10 shadow-sm border border-gray-200 bg-white">
            <div className="mb-8 rounded-lg border border-linkedin/20 bg-linkedin/5 p-4">
              <p className="text-sm font-semibold text-gray-900 mb-2">Already signed up?</p>
              <div className="flex flex-col sm:flex-row gap-2">
                <input
                  type="email"
                  value={returningEmail}
                  onChange={(e) => setReturningEmail(e.target.value)}
                  className="flex-1 px-3 py-2.5 border border-gray-300 rounded-lg bg-white text-sm text-gray-900 focus:outline-none focus:border-linkedin focus:ring-1 focus:ring-linkedin"
            ...
            <div className="text-center mb-8">
              <div className="mx-auto w-12 h-12 rounded-full bg-linkedin/10 flex items-center justify-center mb-4">
              ...
              <p className="text-gray-600 text-sm">
                Sign up to unlock your results dashboard and Career Mentor chatbot.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
              ...
              <Button
                ...
                className="border-linkedin/30 bg-linkedin/5 hover:bg-linkedin/10 text-linkedin"
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              >
                {submitting ? 'Saving...' : 'Unlock My Results'}
              </Button>

              <p className="text-xs text-gray-500 text-center">
                We save your signup and intake metadata so your dashboard and mentor session can be linked to you.
              </p>
            </form>
          </Card>
        </div>
